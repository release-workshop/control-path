...
const DEFINITIONS_SCHEMA_JSON: &str = include_str!("../../../schemas/flag-definitions.schema.v1.json");

/// Embed deployment schema at compile time
/// This avoids file I/O which is not available in WASM environments
const DEPLOYMENT_SCHEMA_JSON: &str = include_str!("../../../schemas/flag-deployment.schema.v1.json");
