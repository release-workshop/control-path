...
impl From<crate::parser::error::ParseError> for ParseError {
    fn from(err: crate::parser::error::ParseError) -> Self {
        match err {
            crate::parser::error::ParseError::InvalidYaml(msg) => ParseError::InvalidYaml(msg),
            crate::parser::error::ParseError::InvalidJson(msg) => ParseError::InvalidJson(msg),
            crate::parser::error::ParseError::MissingField(msg) => ParseError::MissingField(msg),
            crate::parser::error::ParseError::InvalidFieldType(msg) => ParseError::InvalidFieldType(msg),
        }
    }
}
